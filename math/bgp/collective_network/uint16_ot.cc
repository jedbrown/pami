...
#ifdef NOT_USED
static void _core_uint16_conv_o(uint16_t *dst, const uint16_t *src, int count) {
...
static void _core_uint16_conv_not_o(uint16_t *dst, const uint16_t *src, int count) {
...
static void _core_uint16_not_o(uint16_t *dst, const uint16_t *src, int count) {
