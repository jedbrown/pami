...
static void _core_uint64_not_o(uint64_t *dst, const uint64_t *src, int count) {
  _core_uint32_not_o((uint32_t *)dst, (const uint32_t *)src, count<<1);
}

#ifdef NOT_USED
static void _core_uint64_conv_o(uint64_t *dst, const uint64_t *src, int count) {
...
static void _core_uint64_conv_not_o(uint64_t *dst, const uint64_t *src, int count) {
#define OP(a) (~((a)-(0x8000000000000000ULL)))
