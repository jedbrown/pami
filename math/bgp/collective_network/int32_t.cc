...
static void _core_int32_conv(uint32_t *dst, const int32_t *src, int count) {
...
static void _core_int32_conv_not(uint32_t *dst, const int32_t *src, int count) {
#define OP(a) (~((a)+(0x80000000UL)))
...
static void _core_int32_unconv(int32_t *dst, const uint32_t *src, int count) {
#define OP(a) ((a)-(0x80000000UL))
...
static void _core_int32_unconv_not(int32_t *dst, const uint32_t *src, int count) {
#define OP(a) (~((a)-(0x80000000UL)))
...
void _core_int32_post_all(int32_t *dst, const uint32_t *src, int count) {
  _core_int32_unconv(dst, src, count);
}
...
void _core_int32_post_min(int32_t *dst, const uint32_t *src, int count) {
  _core_int32_unconv_not(dst, src, count);
}
