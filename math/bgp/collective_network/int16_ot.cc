...
#ifdef NOT_USED
static void _core_int16_min_conv2(uint16_t *dst, const int16_t **srcs, int nsrc, int count) {
...
static void _core_int16_prod_conv2(uint16_t *dst, const int16_t **srcs, int nsrc, int count) {
...
static void _core_int16_conv_o(uint16_t *dst, const int16_t *src, int count) {
...
static void _core_int16_unconv_o(int16_t *dst, const uint16_t *src, int count) {
...
static void _core_int16_conv_not_o(uint16_t *dst, const int16_t *src, int count) {
...
static void _core_int16_unconv_not_o(int16_t *dst, const uint16_t *src, int count) {
...
void _core_int16_post_all_o(int16_t *dst, const uint16_t *src, int count) {
	_core_int16_unconv_o(dst, src, count); 
}
...
void _core_int16_post_min_o(int16_t *dst, const uint16_t *src, int count) {
	_core_int16_unconv_not_o(dst, src, count); 
}
