...
static void _core_uint8_not_o(uint8_t *dst, const uint8_t *src, int count) {
...
#ifdef NOT_USED
static void _core_uint8_conv_o(uint8_t *dst, const uint8_t *src, int count) {
...
static void _core_uint8_conv_not_o(uint8_t *dst, const uint8_t *src, int count) {
