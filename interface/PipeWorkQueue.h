/**
 * \file devices/prod/workqueue/PipeWorkQueue.h
 *
 * \brief Implementation of a WorkQueue that can be either circular or flat
 *
 * This is a strip-down file with only public interfaces
 */
...
namespace LL {
    namespace WorkQueue {
        ...
        public:
            ...
            ///
            inline void configure(void *sysdep, unsigned bufsize);
            ...
            ///
            inline void configure(void *sysdep, char *buffer, unsigned bufsize);
