...
/// \brief convenient access to pertinent mapping info
///
extern XMI::Mapping::BgpMapping *_g_mapping;
...
namespace Topology {
	class BgpTopology : public Topology<XMI::Topology::BgpTopology> {
		static XMI::Mapping::BgpMapping *mapping;
		...
		/// \return	nothing, but _new may be XMI_EMPTY_TOPOLOGY
		///
		void __subTopologyNthGlobal(XMI::Topology::BgpTopology *_new, int n) {
		...
		///
		void __subTopologyReduceDims(XMI::Topology::BgpTopology *_new, xmi_coord_t *fmt) {
			*_new = *this;
			size_t s = 1;
			unsigned x;
	...
	public:
		static void static_init(XMI::SysDep::BgpSysDep *sd) {
			mapping = &sd->mapping;
		}
		...
		///
		BgpTopology(xmi_coord_t *ll, xmi_coord_t *ur,
		...
		///
		BgpTopology(size_t rank0, size_t rankn) {
			__type = XMI_RANGE_TOPOLOGY;
		...
		///
		BgpTopology(size_t *ranks, size_t nranks) {
		...
		static const unsigned size_of_impl() { return sizeof(BgpTopology); }
		...
		///
		void subTopologyLocalToMe_impl(XMI::Topology::BgpTopology *_new) {
	...
	///
	void unionTopology_impl(BgpTopology *_new, BgpTopology *other) {
