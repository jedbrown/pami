...
/**
 * \file components/geometry/bgp/bgpcollregistration.h
 * \brief ???
 */

#ifndef __components_geometry_bgp_bgpcollregistration_h__
#define __components_geometry_bgp_bgpcollregistration_h__

#define XMI_COLLREGISTRATION_CLASS XMI::CollRegistration::BGP

#include <map>
#include <vector>
#include "components/geometry/bgp/bgpcollinfo.h"
#include "components/geometry/bgp/bgpcollfactory.h"
...
namespace XMI
{
  ...
  namespace CollRegistration
  {
    ...
    class BGP: public CollRegistration<XMI::CollRegistration::BGP<XMI_GEOMETRY_CLASS, T_Collfactory, T_Device, T_Sysdep>, T_Geometry, T_Collfactory>
    {
    public:
      inline BGP(T_Device *dev, T_Sysdep *sd):
      CollRegistration<XMI::CollRegistration::BGP<T_Geometry, T_Collfactory, T_Device, T_Sysdep>, T_Geometry, T_Collfactory>(),
	_dev(dev),
        _sysdep(sd),
#if 0
