...
namespace XMI
{
    namespace Device
    {
        ...
        public Interface::MulticombineModel<MPIMulticombineModel<T_Device, T_Message>,sizeof(T_Message)>
        {
        public:
          ...
          MPIMulticombineModel (T_Device & device, xmi_result_t &status) :
              Interface::MulticombineModel < MPIMulticombineModel<T_Device, T_Message>,sizeof(T_Message) > (status)
                {};
