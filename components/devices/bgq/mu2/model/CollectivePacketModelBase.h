...
namespace PAMI
{
  namespace Device
  {
    namespace MU
    {
      ...
      class CollectivePacketModelBase : public Interface::CollectivePacketModel < MU::CollectivePacketModelBase<T_Model>, MU::Context, 1024 + MU::InjChannel::completion_event_state_bytes, unsigned >
      {
        protected :
        ...
        public:
          ...
          inline bool postCollectivePacket (unsigned       route,
                                       void         * metadata,
                                       size_t         metasize,
          ...
          /// \see PAMI::Device::Interface::CollectivePacketModel::postCollectivePacket
          template <unsigned T_Niov>
          inline bool postCollectivePacket (uint8_t               (&state)[packet_model_state_bytes],
          ...
          /// \see PAMI::Device::Interface::CollectivePacketModel::postMultiPacket
      ...
      template <class T_Model>
      CollectivePacketModelBase<T_Model>::CollectivePacketModelBase (MU::Context & context, void * cookie) :
          Interface::CollectivePacketModel < MU::CollectivePacketModelBase<T_Model>, MU::Context, 1024 + MU::InjChannel::completion_event_state_bytes, unsigned > (context),
          _context (context),
          _cookie (cookie)
      {
        TRACE_FN_ENTER();
        ...
        collective.Op_Code = MUHWI_COLLECTIVE_OP_CODE_SIGNED_ADD;/// \todo not true? ignored for MUHWI_COLLECTIVE_TYPE_BROADCAST
        collective.Word_Length = 0; /// \todo not true? ignored for MUHWI_COLLECTIVE_TYPE_BROADCAST
        collective.Class_Route = 0; 
        collective.Misc = MUHWI_PACKET_VIRTUAL_CHANNEL_USER_COMM_WORLD | MUHWI_COLLECTIVE_TYPE_BROADCAST;
        collective.Skip = 0;
      ...
      template <class T_Model>
      pami_result_t CollectivePacketModelBase<T_Model>::init_impl (size_t                      dispatch,
                                                         Interface::RecvFunction_t   direct_recv_func,
                                                         void                      * direct_recv_func_parm,
                                                         Interface::RecvFunction_t   read_recv_func,
                                                         void                      * read_recv_func_parm)
      ...
      template <class T_Model>
      template <unsigned T_Niov>
      bool CollectivePacketModelBase<T_Model>::postCollectivePacket (unsigned              route,
                                                      void         * metadata,
                                                      size_t         metasize,
                                                      struct iovec   (&iov)[T_Niov])
      {
      ...
      template <class T_Model>
      template <unsigned T_Niov>
      bool CollectivePacketModelBase<T_Model>::postCollectivePacket (uint8_t               (&state)[packet_model_state_bytes],
                                                      pami_event_function   fn,
                                                      void                * cookie,
                                                      unsigned              route,
                                                      void                * metadata,
      ...
      template <class T_Model>
      bool CollectivePacketModelBase<T_Model>::postMultiPacket_impl (uint8_t               (&state)[packet_model_state_bytes],
                                                           pami_event_function   fn,
                                                           void                * cookie,
                                                           unsigned              route,
                                                           void                * metadata,
