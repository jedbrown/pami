...
namespace PAMI
{
  namespace Device
  {
    namespace Interface
    {
      ...
      /// \see PacketModel
      ///
      template <class T_Model, class T_Device, unsigned T_StateBytes, class T_Route>
      class CollectivePacketModel
      {
        public:
          ...
          inline bool postCollectivePacket (T_Route     route,
                                            void         * metadata,
                                            size_t         metasize,
          ...
          ///               callback is invoked
          ///
          inline bool postMultiCollective Packet (uint8_t              (&state)[T_StateBytes],
                                                  pami_event_function   fn,
                                                  void               * cookie,
                                                  T_Route              route,
                                                  void               * metadata,
      ...
      template <unsigned T_Niov>
      inline bool CollectivePacketModel<T_Model, T_Device, T_StateBytes>::postCollectivePacket (T_Route     route,
          void         * metadata,
          size_t         metasize,
          struct iovec   (&iov)[T_Niov])
      {
        return static_cast<T_Model*>(this)->postCollectivePacket_impl (route, metadata, metasize, iov);
      }

      template <class T_Model, class T_Device, unsigned T_StateBytes>
      inline bool CollectivePacketModel<T_Model, T_Device, T_StateBytes>::postCollectivePacket (uint8_t              (&state)[T_StateBytes],
          pami_event_function   fn,
          void               * cookie,
          T_Route              route,
          void               * metadata,
      ...
      template <class T_Model, class T_Device, unsigned T_StateBytes>
      inline bool CollectivePacketModel<T_Model, T_Device, T_StateBytes>::postMultiCollective Packet (uint8_t              (&state)[T_StateBytes],
          pami_event_function   fn,
          void               * cookie,
          T_Route              route,
          void               * metadata,
