/**
 * \file components/devices/shmemcoll/2way_min.h
 * \brief ???
 */
#ifndef __components_devices_shmemcoll_2way_min_h__
#define __components_devices_shmemcoll_2way_min_h__
