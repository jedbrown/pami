/**
 * \file components/devices/shmemcoll/16way_max.h
 * \brief ???
 */
#ifndef __components_devices_shmemcoll_16way_max_h__
#define __components_devices_shmemcoll_16way_max_h__
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  ASM("qvfadd 28, 28, 15" ::  ); //first first-half max done
  ...
  ASM("qvfadd 30, 30, 17" ::  );
  VECTOR_LOAD(src0_1,inc,16);
  ASM("qvfadd 29, 0, 1" ::  ); 	//second first-half max start
  ...
  VECTOR_LOAD(src10_1,inc,10);
  ASM("qvfadd 30, 30, 19" ::  ); //first second-half max done
  VECTOR_LOAD(src2_1,inc,18);
  ASM("qvfadd 29, 29, 3" ::  );
  ...
  VECTOR_LOAD(src12_1,inc,12);
  ASM("qvfadd 31, 16, 17" ::  ); //second second-half max start
  VECTOR_LOAD(src4_1,inc,16);
  ASM("qvfadd 29, 29, 5" ::  );
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  VECTOR_LOAD(src10_1,inc,10);
  ASM("qvfadd 30, 30, 15" ::  ); //first second-half max done
  VECTOR_LOAD(src2_1,inc,2);
  ASM("qvfadd 29, 29, 3" ::  );
  ...
  VECTOR_LOAD(src12_1,inc,12);
  ASM("qvfadd 31, 0, 1" ::  ); //second second-half max start
  VECTOR_LOAD(src4_1,inc,4);
  ASM("qvfadd 29, 29, 5" ::  );
  VECTOR_STORE(dst_2,inc1,30);
