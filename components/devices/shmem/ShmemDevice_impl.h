...
namespace PAMI
{
  namespace Device
  {
    ...
    pami_result_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::init (pami_client_t  client,
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    bool ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::isInit_impl ()
    {
      return true;
    }
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    size_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::peers_impl ()
    {
      return _npeers;
    }
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    size_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::task2peer_impl (size_t task)
    {
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    bool ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::isPeer_impl (size_t task)
    {
      return __global.mapping.isLocal(task);
    };

    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    pami_result_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::registerRecvFunction (size_t                      set,
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    pami_result_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::registerSystemRecvFunction (Interface::RecvFunction_t   recv_func,
        void                      * recv_func_parm,
        uint16_t                  & id)
    {
    ...
    template <class T_Fifo, class T_Shaddr, unsigned T_FifoCount>
    pami_result_t ShmemDevice<T_Fifo, T_Shaddr, T_FifoCount>::postCompletion
