/**
 * \file components/devices/shmemcoll/16way_min.h
 * \brief ???
 */
#ifndef __components_devices_shmemcoll_16way_min_h__
#define __components_devices_shmemcoll_16way_min_h__
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
 ...
 register  double *dst_1, *dst_2;
  ...
  ASM("qvfadd 28, 28, 15" ::  ); //first first-half min done
  ...
  ASM("qvfadd 30, 30, 17" ::  );
  VECTOR_LOAD(src0_1,inc,16);
  ASM("qvfadd 29, 0, 1" ::  ); 	//second first-half min start
  ...
  VECTOR_LOAD(src10_1,inc,10);
  ASM("qvfadd 30, 30, 19" ::  ); //first second-half min done
  VECTOR_LOAD(src2_1,inc,18);
  ASM("qvfadd 29, 29, 3" ::  );
  ...
  VECTOR_LOAD(src12_1,inc,12);
  ASM("qvfadd 31, 16, 17" ::  ); //second second-half min start
  VECTOR_LOAD(src4_1,inc,16);
  ASM("qvfadd 29, 29, 5" ::  );
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  VECTOR_LOAD(src10_1,inc,10);
  ASM("qvfadd 30, 30, 15" ::  ); //first second-half min done
  VECTOR_LOAD(src2_1,inc,2);
  ASM("qvfadd 29, 29, 3" ::  );
  ...
  VECTOR_LOAD(src12_1,inc,12);
  ASM("qvfadd 31, 0, 1" ::  ); //second second-half min start
  VECTOR_LOAD(src4_1,inc,4);
  ASM("qvfadd 29, 29, 5" ::  );
  VECTOR_STORE(dst_2,inc1,30);
    ...
    double* src12, double* src13, double* src14, double* src15, unsigned num_dbls)
{
  ...
  if (y == 1)
  {
    ...
    ASM("qvfmr 31, 3" ::  );
    //ASM("qvfadd 28, 28, 4" ::  );
    ASM("qvfcmplt 16, 28, 4" :: );
    ASM("qvfsel 28, 16, 28, 4" :: );
    //ASM("qvfadd 29, 29, 5" ::  );
    ASM("qvfcmplt 16, 29, 5" :: );
    ASM("qvfsel 29, 16, 29, 5" :: );
    //ASM("qvfadd 30, 30, 6" ::  );
    ASM("qvfcmplt 16, 30, 6" :: );
    ASM("qvfsel 30, 16, 30, 6" :: );
    //ASM("qvfadd 31, 31, 7" ::  );
    ASM("qvfcmplt 16, 31, 7" :: );
    ASM("qvfsel 31, 16, 31, 7" :: );
    //ASM("qvfadd 28, 28, 8" ::  );
    ASM("qvfcmplt 16, 28, 8" :: );
    ASM("qvfsel 28, 16, 28, 8" :: );
    //ASM("qvfadd 29, 29, 9" ::  );
    ASM("qvfcmplt 16, 29, 9" :: );
    ASM("qvfsel 29, 16, 29, 9" :: );
    //ASM("qvfadd 30, 30, 10" ::  );
    ASM("qvfcmplt 16, 30, 10" :: );
    ASM("qvfsel 30, 16, 30, 10" :: );
    //ASM("qvfadd 31, 31, 11" ::  );
    ASM("qvfcmplt 16, 31, 11" :: );
    ASM("qvfsel 31, 16, 31, 11" :: );
    //ASM("qvfadd 28, 28, 12" ::  );
    ASM("qvfcmplt 16, 28, 12" :: );
    ASM("qvfsel 28, 16, 28, 12" :: );
    //ASM("qvfadd 29, 29, 13" ::  );
    ASM("qvfcmplt 16, 29, 13" :: );
    ASM("qvfsel 29, 16, 29, 13" :: );
    //ASM("qvfadd 30, 30, 14" ::  );
    ASM("qvfcmplt 16, 30, 14" :: );
    ASM("qvfsel 30, 16, 30, 14" :: );
    //ASM("qvfadd 31, 31, 15" ::  );
    ASM("qvfcmplt 16, 31, 15" :: );
    ASM("qvfsel 31, 16, 31, 15" :: );
    //ASM("qvfadd 29, 29, 28" ::  );
    ASM("qvfcmplt 16, 29, 28" :: );
    ASM("qvfsel 29, 16, 29, 28" :: );
    //ASM("qvfadd 31, 31, 30" ::  );
    ASM("qvfcmplt 16, 31, 30" :: );
    ASM("qvfsel 31, 16, 31, 30" :: );
    //ASM("qvfadd 31, 31, 29" ::  );
    ASM("qvfcmplt 16, 31, 29" :: );
    ASM("qvfsel 31, 16, 31, 29" :: );
