    ...
    class ShmemPacketModel : public Interface::MessageModel<ShmemPacketModel<T_Device, T_Message>, T_Device, T_Message>
    {
      public:
        ...
        ShmemPacketModel (T_Device & device) :
            Interface::MessageModel < ShmemPacketModel<T_Device, T_Message>, T_Device, T_Message > (device),
            _device (device)
        {};
                                     ...
                                     size_t               bytes)
        {
          ...
          new (obj) T_Message (fn, cookie, _dispatch_id, metadata, metasize, payload, bytes, true);
                                     ...
                                     size_t               bytes1)
        {
          ...
          new (obj) T_Message (fn, cookie, _dispatch_id, metadata, metasize,
                                     ...
                                     size_t             niov)
        {
          ...
          new (obj) T_Message (fn, cookie, _dispatch_id, metadata, metasize, iov, niov, true);
                                      ...
                                      size_t             bytes)
        {
          ...
          new (obj) T_Message (fn, cookie, _dispatch_id, metadata, metasize, src, bytes, false);
