...
namespace XMI
{
  namespace Device
  {
    ...
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::init_impl (XMI::SysDep * sysdep)
    {
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    bool ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::isInit_impl ()
    {
      return true;
    }
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    size_t ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::peers_impl ()
    {
      return _num_procs;
    }
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    size_t ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::task2peer_impl (size_t task)
    {
    ...
    ///
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::registerRecvFunction (size_t                      id,
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    xmi_result_t ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::post (size_t fnum, ShmemBaseMessage<T_Packet> * msg)
    {
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::noop (void   * metadata,
                                                              void   * payload,
                                                              size_t   bytes,
                                                              void   * recv_func_parm,
                                                              void   * cookie)
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::advance_sendQ ()
    {
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::advance_sendQ (size_t peer)
    {
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::advance_doneQ ()
    {
      size_t peer;
      int events = 0;
    ...
    template <class T_Fifo, class T_Packet, class T_Memregion>
    int ShmemBaseDevice<T_Fifo, T_Packet, T_Memregion>::advance_doneQ (size_t peer)
    {
      int events = 0;
      size_t last_rec_seq_id = _fifo[peer].lastRecSequenceId ();
      ShmemBaseMessage<T_Packet> * msg;
