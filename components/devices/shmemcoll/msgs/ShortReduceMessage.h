...
/**
 * \file components/devices/shmemcoll/msgs/ShortReduceMessage.h
 * \brief ???
 */

#ifndef __components_devices_shmemcoll_msgs_ShortReduceMessage_h__
#define __components_devices_shmemcoll_msgs_ShortReduceMessage_h__
