...
#include "test/internals/multisend/generic/multicast.h"
...
// ------------------------------------------------------------------------
  ...
  // output topology with everyone except root
...
// ------------------------------------------------------------------------
  {
    ...
    // simple bcast on the local topology
...
// ------------------------------------------------------------------------
    ...
    if(task_id == root) fprintf(stderr, "=== Testing %s all local...\n", test);
    sleep(1);
