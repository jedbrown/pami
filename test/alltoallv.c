...
void _barrier (pami_context_t context, pami_barrier_t *barrier)
{
  _g_barrier_active++;
...
int main(int argc, char*argv[])
{
  ...
  pami_algorithm_t *alltoallvalgorithm;
