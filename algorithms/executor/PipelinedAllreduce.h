...
namespace CCMI
{
  namespace Executor
  {
    ...
    private:
      ...
      static void pipeAllreduceNotifySend (xmi_client_t client, size_t ctxt, void *cd, xmi_result_t err)
      {
      ...
      static void pipeAllreduceNotifyReceive (xmi_client_t client, size_t ctxt, void *cd, xmi_result_t err)
      {
    ...
    protected:
      ...
      void processDone ()
      {
        ...
        {
          this->_cb_done (NULL, 0, this->_clientdata, XMI_SUCCESS);
          //_curSendPhase = -1;
          //_curRecvPhase = -1;
        }
      }
