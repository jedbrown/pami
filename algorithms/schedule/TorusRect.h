  ...
  switch (_op)
  {
	...
	getReduceSrcTopology(phase, topo);
      //Return self topology after bcast phases to notify bcast
	       ...
	       MY_TASK != _root)
	new (topo) PAMI::Topology(MY_TASK);
      break;
...
/**
   ...
   */
inline void
CCMI::Schedule::TorusRect::getBcastAxialAttributes(unsigned  phase,  
						   int     & raxis, 
						   size_t  & ll, 
						   size_t  & ur, 
						   uint8_t & tlink) 
 ...
 */
inline void
CCMI::Schedule::TorusRect::setupBcastGhost(int     & raxis, 
					   size_t  & ll, 
					   size_t  & ur, 
					   uint8_t & tlink)
{
 ...
 */
inline void
CCMI::Schedule::TorusRect::setupBcastLocal(int     & raxis, 
					   size_t  & ll, 
					   size_t  & ur, 
					   uint8_t & tlink)
{
...
inline unsigned
CCMI::Schedule::TorusRect::getReduceAxis(unsigned phase)
{
...
inline unsigned
CCMI::Schedule::TorusRect::getLastReducePhase()
{
...
inline pami_result_t
CCMI::Schedule::TorusRect::setupReduceLocalTopology(unsigned phase,
                                                    int data_movement,
                                                    PAMI::Topology * topo)
{
  pami_network type;
...
inline pami_result_t
CCMI::Schedule::TorusRect::getReduceSrcTopology(unsigned phase,
                                                PAMI::Topology * topo)
{
  pami_result_t result = PAMI_SUCCESS;
  ...
  if (COORD(_self_coord, TORUS_DIMS) > 0) return result;
...
inline pami_result_t
CCMI::Schedule::TorusRect::getReduceDstTopology(unsigned phase,
                                                PAMI::Topology * topo)
{
...
inline pami_result_t
CCMI::Schedule::TorusRect::setupReduceGhostTopology(unsigned phase,
                                                    int data_movement, 
                                                    PAMI::Topology * topo)
{
  pami_network type;
