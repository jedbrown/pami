        ...
        AMScatterFactoryT (pami_context_t                ctxt,
                                                 ...
                                                 size_t                                            sndlen)
          {
            ...
            if(!(flag & LocalPosted))
            {
              ...
              composite->dataExecutor().setBuffers (NULL, ead->buf, cdata->_count,
                                                    (TypeCode *) PAMI_TYPE_BYTE,
                                                    (TypeCode *) PAMI_TYPE_BYTE);
            }
            ...
            if (factory->_native->endpoint() != root)
              {
                ...
                PAMI::Geometry::DispatchInfo *dispatch =
                  co->getGeometry()->getDispatch(a_xfer->cmd.xfer_amscatter.dispatch);
                PAMI_assertf(dispatch != NULL, "Invalid dispatch ID: %zu\n",
                ...
                else
                {
                  ...
                  composite->dataExecutor().setBuffers((char *)NULL,
                                                       (char *)recv.addr,
                                                       a_xfer->cmd.xfer_amscatter.stypecount,
                                                       (TypeCode *) recv.type,
