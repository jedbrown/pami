...
namespace TSPColl
{
  ...
  private:
    static void scattercomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res);
    static void barriercomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res);
    static void barrier2complete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res);
    static void barrier3complete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res);
    static void allgathervcomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res);
  };
}
...
/* *********************************************************************** */
template <class T_Mcast>
inline void TSPColl::ScBcast<T_Mcast>::scattercomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res)
{
...
/* *********************************************************************** */
template <class T_Mcast>
inline void TSPColl::ScBcast<T_Mcast>::barriercomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res)
{
  ScBcast * self = (ScBcast *) arg;
...
/* *********************************************************************** */
template <class T_Mcast>
inline void TSPColl::ScBcast<T_Mcast>::barrier2complete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res)
{
  ScBcast * self = (ScBcast *) arg;
...
/* *********************************************************************** */
template <class T_Mcast>
inline void TSPColl::ScBcast<T_Mcast>::barrier3complete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res)
{
...
/* *********************************************************************** */
template <class T_Mcast>
inline void TSPColl::ScBcast<T_Mcast>::allgathervcomplete(xmi_client_t client, size_t ctxt, void *arg, xmi_result_t res)
{
  ScBcast * self = (ScBcast *) arg;
