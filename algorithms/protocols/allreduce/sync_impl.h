    ...
    namespace Allreduce
    {
      ...
      namespace Binomial
      {
        ...
        <CCMI::Schedule::BinomialTreeSchedule<XMI_SYSDEP_CLASS>,
         ...
         CCMI::ConnectionManager::RankBasedConnMgr<XMI_SYSDEP_CLASS> > Composite;
      ...
      template<> inline void Binomial::Composite::create_schedule(XMI_SYSDEP_CLASS * map,XMI_GEOMETRY_CLASS * geometry,CCMI::Schedule::Color color)
      {
      ...
      template<> inline void ShortBinomial::Composite::create_schedule(XMI_SYSDEP_CLASS * map,XMI_GEOMETRY_CLASS * geometry,CCMI::Schedule::Color color)
      {
        new (_schedule) CCMI::Schedule::BinomialTreeSchedule<XMI_SYSDEP_CLASS>(map, geometry->nranks(), geometry->ranks());
      };
