  ...
  namespace Adaptor
  {
    namespace Allreduce
    {
      namespace Tree
      {
        ...
        extern int checkOp(CM_Dt dt, CM_Op op);
        ...
        public:
          ...
          /// 
          static void cb_reduceCompositeDone(void *me, CM_Error_t *err)
          {
          ...
          /// 
          static void cb_endBarrierDone(void *me, CM_Error_t *err)
          {
            TRACE_ADAPTOR((stderr,
