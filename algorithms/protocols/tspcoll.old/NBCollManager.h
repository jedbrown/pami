...
/**
 * \file algorithms/protocols/tspcoll.old/NBCollManager.h
 * \brief ???
 */

#ifndef __algorithms_protocols_tspcoll_old_NBCollManager_h__
#define __algorithms_protocols_tspcoll_old_NBCollManager_h__
...
//TSPColl::NBCollManager * TSPColl::NBCollManager::_instance = NULL;
  ...
  void TSPColl::NBCollManager<T_NI>::initialize (void)
  {
    for (int i = 0; i < MAXTAG; i++)
      {
	pami_result_t prc;
	prc = __global.heap_mm->memalign((void **)&_taglist[i], 0,
