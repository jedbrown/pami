  ...
  namespace Adaptor
  {
    namespace Broadcast
    {
      ...
      public:
        ...
        ///
        static void staticAsyncRecvFn (xmi_client_t client, size_t context, void *clientdata, xmi_result_t err)
        {
      ...
      public:
        ...
        static void unexpected_done (xmi_client_t client, size_t context, void *cd, xmi_result_t err)
        {
        ...
        static void posted_done (xmi_client_t client, size_t context, void *cd, xmi_result_t err)
        {
