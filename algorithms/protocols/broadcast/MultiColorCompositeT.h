...
//      <class T_Sysdep, class T_Mcast, class T_ConnectionManager>
      ...
      ///
        static void staticRecvFn (xmi_client_t client, size_t ctxt, void *executor, xmi_result_t err)
          {
        ...
        ///
        static void cb_barrier_done(xmi_client_t client, size_t ctxt, void *me, xmi_result_t err)
        {
          ...
          {
            bcast_composite->_cb_done.function(NULL, 0, bcast_composite->_cb_done.clientdata,XMI_SUCCESS);
          }
        }

        static void cb_bcast_done(xmi_client_t client, size_t ctxt, void *me, xmi_result_t err)
        {
          MultiColorCompositeT * bcast_composite = (MultiColorCompositeT *) me;
          CCMI_assert (bcast_composite != NULL);
          ...
          if(bcast_composite->_doneCount == bcast_composite->_nComplete) // call users done function
          {
            bcast_composite->_cb_done.function(client, ctxt, bcast_composite->_cb_done.clientdata, XMI_SUCCESS);
          }
        }
