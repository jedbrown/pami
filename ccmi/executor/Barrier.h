...
namespace CCMI
{
  namespace Executor
  {
    ...
    public:
      ...
      MultiSend::MulticastInterface   * _mcastInterface;
      ...
      MultiSend::CCMI_Multicast_t    _minfo;
    ...
    public:
      ...
      Barrier(unsigned nranks, unsigned *ranks,unsigned comm,
              unsigned connid,
              MultiSend::MulticastInterface   * minterface):
      Executor(),
      ...
      _connid(connid)
      {
        ...
        _minfo.setInfo((CCMIQuad *)((void *) &_cdata),  1);
      ...
      virtual void notifyRecv(unsigned src, const CCMIQuad &info, char *buf, unsigned len);
      ...
      void internalNotifySendDone( const CCMIQuad & info );
...
inline void CCMI::Executor::Barrier::sendNext()
{
  ...
  TRACE_ERR((stderr,"<%X>Executor::Barrier::sendNext _phase %d, ndest %d, _destrank %d, _connid %d, _clientdata %X\n",
...
///
inline void CCMI::Executor::Barrier::internalNotifySendDone( const CCMIQuad & info )
{
