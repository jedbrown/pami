...
/**
 * \file collectives/bgp/protocols/allreduce/Factory.h
 * \brief CCMI factory for [all]reduce composite
 */


#ifndef __ccmi_collectives_allreduce_factory_h__
#define __ccmi_collectives_allreduce_factory_h__
    ...
    namespace Allreduce
    {
      ...
      public:
                                               ...
                                               unsigned color)
        {
          ...
          ((Geometry *)_cb_geometry(comm))->getAllreduceComposite();
