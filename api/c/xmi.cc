...
///
size_t XMI_Topology_taskID2Index(xmi_topology_t *topo, xmi_task_t rank)
{
    XMI::Topology * t = (XMI::Topology *) topo;
...
///
void XMI_Topology_getTaskList(xmi_topology_t *topo, size_t max, xmi_task_t *ranks, size_t *nranks)
{
    XMI::Topology * t = (XMI::Topology *) topo;
