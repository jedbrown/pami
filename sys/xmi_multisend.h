...
#warning Exposing Deprecated ManyToMany interfaces
  ...
  xmi_result_t DCMF_Manytomany_register (XMI_Protocol_t                 * registration, /* DEPRECATED */
   ...
   */
  xmi_result_t XMI_Manytomany_register(XMI_Protocol_t *registration,
   ...
   */
  xmi_result_t XMI_Multisync_register(XMI_Protocol_t   *registration,
   ...
   * \return	XMI_SUCCESS or error codes
   */
  xmi_result_t XMI_Multicombine_register(XMI_Protocol_t   *registration,
