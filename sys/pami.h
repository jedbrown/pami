...
extern "C"
{
  ...
  typedef uint32_t pami_task_t;    /**< This should be generated by configure. */
  typedef uint32_t pami_endpoint_t;/**< foo */
   ...
   * Return value < 0 indicates -(pami_result_t) and stops function from
   * being called. Return value of PAMI_SUCCESS (0) stops function.
   *
   * \param[in] context   PAMI communication context running function
   * \param[in] cookie    application argument
   * \return	(0) PAMI_SUCCESS causes function to dequeue (stop running)
...
#include "pami_ext.h"
  ...
  typedef char* pami_user_key_t;   /**< ??? */
  typedef char* pami_user_value_t; /**< ??? */
  typedef struct
  {
