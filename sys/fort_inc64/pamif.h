...
! typedef char* pami_user_value_t; /**< Char string as configuration value */
    ...
    type pami_user_config_t
        sequence
        integer(8)  :: key      ! /**< The configuration key   */
        integer(8)  :: value    ! /**< The configuration value */
...
!  */
    type pami_metadata_t
        ...
        integer(8)  :: check_fn     ! /**<  A function pointer to validate parameters for the collective operation.  Can be NULL if no correctness check is required */
        integer(8)  :: range_lo     ! /**<  This protocol has minumum bytes to send/recv requirements */
        integer(8)  :: range_hi     ! /**<  This protocol has maximum bytes to send/recv requirements */
        ...
        integer(4)  :: paddings_
        integer(8)  :: range_lo_perf! /**<  Estimated performance range in bytes(low) */
        integer(8)  :: range_hi_perf! /**<  Estimated performance range in bytes(high) */
...
!  */
    type pami_send_hint_t
        sequence
        integer(8)  :: buffer_registered ! /**< Send and receive buffers are ready for RDMA operations */
        integer(8)  :: consistency       ! /**< Force match ordering semantics */
        integer(8)  :: interrupt_on_recv ! /**< Interrupt the remote task when the first packet arrives */
        integer(8)  :: no_local_copy     ! /**< Disable PAMI making a local copy of data */
        integer(8)  :: no_long_header    ! /**< Disable long header support */
        integer(8)  :: recv_immediate    ! /**< Assert that sends will result in an 'immediate' receive */
        ! /* The following hints use the PAMI_HINT3_* values */
        integer(8)  :: use_rdma          ! /**< Enable/Disable rdma operations */
        integer(8)  :: use_shmem         ! /**< Enable/Disable shared memory optimizations */
        integer(8)  :: multicontext      ! /**< Parallelize communication across multiple contexts */
...
!  */
    type pami_send_immediate_t
        sequence
        integer(8)  :: header(2)    ! /**< Header buffer address and size in bytes */
        integer(8)  :: data(2)      ! /**< Data buffer address and size in bytes */
        integer(8)  :: dispatch     ! /**< Dispatch identifier */
        integer(8)  :: hints(9)     ! /**< Hints for sending the message */
        integer(8)  :: dest         ! /**< Destination endpoint */
...
!  */
    type pami_send_event_t
        sequence
        integer(8)  :: cookie       ! /**< Argument to \b all event callbacks */
        integer(8)  :: local_fn     ! /**< Local message completion event */
        integer(8)  :: remote_fn    ! /**< Remote message completion event */
...
!  */
    type pami_send_t
        sequence
        integer(8)  :: send(15)     ! /**< Common send parameters */
        integer(8)  :: events(3)    ! /**< Non-blocking event parameters */
...
!  */
    type pami_send_typed_t
        sequence
        integer(4)  :: send(20)     ! /**< Common send parameters */ 
        integer(8)  :: events(3)    ! /**< Non-blocking event parameters */
        integer(8)  :: type         ! /**< Datatype */
        integer(8)  :: offset       ! /**< Starting offset in \c datatype */
        integer(8)  :: data_fn      ! /**< Function to produce data */
...
!  */
    type pami_recv_t
        ...
        integer(8)  :: cookie       ! /**< Argument to \b all event callbacks */
        integer(8)  :: local_fn     ! /**< Local message completion event */
        integer(8)  :: addr         ! /**< Starting address of the buffer */
        integer(8)  :: type         ! /**< Datatype */
        integer(8)  :: offset       ! /**< Starting offset of the type */
        integer(8)  :: data_fn      ! /**< Function to consume data */
...
!  **/
    type pami_rma_t
        ...
        integer(8)  :: bytes        ! /**< Data transfer size in bytes */
        integer(8)  :: cookie       ! /**< Argument to \b all event callbacks */
        integer(8)  :: done_fn      ! /**< Local completion event */ 
    end type pami_rma_t
...
!  **/
    type pami_rma_addr_t
        sequence
        integer(8)  :: local    ! /**< Local transfer virtual address */
        integer(8)  :: remote   ! /**< Remote transfer virtual address */
...
!  */
    type pami_rma_typed_t
        sequence
        integer(8)  :: local    ! /**< Data type of local buffer */
        integer(8)  :: remote   ! /**< Data type of remote buffer */
...
!  */
    type pami_rma_put_t
        sequence
        integer(8)  :: rdone_fn     ! /**< Remote completion event - all local data has been received by remote task */
...
!  */
    type pami_put_simple_t
        sequence
        integer(8)  :: rma(8)   ! /**< Common rma parameters */
        integer(8)  :: addr(2)  ! /**< Simple rma address parameters */
        integer(8)  :: put      ! /**< Common put parameters */
...
!  */
    type pami_put_typed_t
        ...
        integer(8)  :: rma(8)   ! /**< Common rma parameters */
        integer(8)  :: addr(2)  ! /**< Simple rma address parameters */
        integer(8)  :: type(2)  ! /**< Simple rma typed parameters */
        integer(8)  :: put      ! /**< Common put parameters */
...
! /** \brief Atomic rmw comparison type */
    ...
    type pami_rmw_t
        sequence
        integer(8)  :: rma(8)       ! /**< Common rma parameters */
        integer(8)  :: addr(2)      ! /**< Rma addresses parameters */
        ...
        integer(4)  :: paddings
        integer(8)  :: value        ! /**< 64-bit data value */
        integer(8)  :: test         ! /**< 64-bit test value */
    end type pami_rmw_t
...
!  pami_result_t PAMI_Memregion_destroy (pami_context_t     context,pami_memregion_t * memregion);
    ...
    type pami_rma_mr_t
        sequence
        integer(8)  :: mr       ! /**< Memory region */
        integer(8)  :: offset   ! /**< Offset from beginning of memory region */
    end type pami_rma_mr_t

    type pami_rdma_t
        sequence
        integer(8)  :: local(2) ! /**< Local memory region information */
        integer(8)  :: remote(2)! /**< Remote memory region information */
...
!  */
    type pami_rput_simple_t
        sequence
        integer(8)  :: rma(8)   ! /**< Common rma parameters */
        integer(8)  :: rdma(4)  ! /**< Common rdma memregion parameters */
        integer(8)  :: put      ! /**< Common put parameters */
...
!  */
    type pami_rput_typed_t
        ...
        integer(8)  :: rma(8)   ! /**< Common rma parameters */
        integer(8)  :: rdma(4)  ! /**< Common rdma memregion parameters */
        integer(8)  :: type(2)  ! /**< Common rma typed parameters */
        integer(8)  :: put      ! /**< Common put parameters */
...
!  */
    type pami_alltoallv_t
        ...
        integer(8)  :: sndbuf
        integer(8)  :: stype
        integer(8)  :: stypecounts
        integer(8)  :: sdispls
        integer(8)  :: rcvbuf
        integer(8)  :: rtype
        integer(8)  :: rtypecounts
        integer(8)  :: rdispls
...
!  */
    type pami_alltoall_t
        ...
        integer(8)  :: sndbuf
        integer(8)  :: stype
        integer(8)  :: stypecount
        integer(8)  :: rcvbuf
        integer(8)  :: rtype
        integer(8)  :: rtypecount
...
!  typedef union
!  {
!    pami_allreduce_t        xfer_allreduce;       ! 8*7 bytes 
!    pami_broadcast_t        xfer_broadcast;       ! 8*4
!    pami_reduce_t           xfer_reduce;           ! 8*8
!    pami_allgather_t        xfer_allgather;        ! 8*6
!    pami_allgatherv_t       xfer_allgatherv;       ! 8*7
!    pami_allgatherv_int_t   xfer_allgatherv_int;   ! 8*7
!    pami_scatter_t          xfer_scatter;          ! 8*7
!    pami_scatterv_t         xfer_scatterv;         ! 8*8
!    pami_scatterv_int_t     xfer_scatterv_int;     ! 8*8
!    pami_gather_t           xfer_gather;           ! 8*7
!    pami_gatherv_t          xfer_gatherv;          ! 8*8
!    pami_gatherv_int_t      xfer_gatherv_int;      ! 8*8
!    pami_alltoall_t         xfer_alltoall;         ! 8*6
!    pami_alltoallv_t        xfer_alltoallv;        ! 8*8
!    pami_alltoallv_int_t    xfer_alltoallv_int;    ! 8*8
!    pami_ambroadcast_t      xfer_ambroadcast;      ! 8*6
!    pami_amscatter_t        xfer_amscatter;        ! 8*6
!    pami_amgather_t         xfer_amgather;         ! 8*6
!    pami_amreduce_t         xfer_amreduce;         ! 8*7
!    pami_scan_t             xfer_scan;             ! 8*7.5
!    pami_barrier_t          xfer_barrier;          ! 8*0
!    pami_fence_t            xfer_fence;            ! 8*0
!    pami_reduce_scatter_t   xfer_reduce_scatter;   ! 8*8
!  } pami_collective_t;
    ...
    type pami_xfer_t
        ...
        integer(8)  :: algorithm
        integer(8)  :: options
        integer(8)  :: cmd(8)       ! the largest slot sizes of pami_collective_t 
...
!  */
    type pami_dispatch_hint_t
        ...
        integer(8)  :: config   ! /**< Type-specific additional config*/
