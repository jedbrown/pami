...
#define XMI_CA_NUM_ELEMENTS    1
   ...
   */
  void XMI_Topology_create_list(xmi_topology_t *topo, xmi_task_t *tasks, xmi_ntask_t ntasks);
   ...
   * \return	index of task (task(ix) == task) or (xmi_ntask_t)-1
   */
  xmi_ntask_t XMI_Topology_taskID2Index(xmi_topology_t *topo, xmi_task_t task);
   ...
   */
  void XMI_Topology_getTaskList(xmi_topology_t *topo, xmi_ntask_t max, xmi_task_t *tasks, xmi_ntask_t *ntasks);
