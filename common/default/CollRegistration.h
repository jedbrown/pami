...
namespace XMI
{
  ...
  namespace CollRegistration
  {
	...
	_pgbarrier(dev),
        ...
        _ccmioldbarrier(dev, sd, mapidtogeometry, context, context_id),
	_ccmioldbinombroadcast(dev, sd, mapidtogeometry, context, context_id),
	_ccmioldringbroadcast(dev, sd, mapidtogeometry, context, context_id),
	_ccmibarrier(dev, sd, mapidtogeometry, context, context_id, client_id),
	_ccmiringbroadcast(dev, sd, mapidtogeometry, context, context_id, client_id),
        _ccmibinombroadcast(dev, sd, mapidtogeometry, context, context_id, client_id),
	...
	_ccmialltoallv(dev,sd)
	  ...
	  _barriers.push_back(&_pgbarrier);
          ...
          _ccmioldbarrier._colltype=XMI::CollInfo::CI_BARRIER1;
          _barriers.push_back(&_ccmioldbarrier);
	...
	f->add_collective(XMI_XFER_BARRIER,    &_pgbarrier);
        f->add_collective(XMI_XFER_BARRIER,    &_ccmioldbarrier);
        _ccmioldbarrier.reg_geometry(geometry);
