...
namespace XMI
{
  ...
  namespace CollRegistration
  {
	...
	_ccmiringbroadcast(dev, sd, mapidtogeometry,_client, context, context_id, client_id),
        _ccmibinombroadcast(dev, sd, mapidtogeometry, _client, context, context_id, client_id),
