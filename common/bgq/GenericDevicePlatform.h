...
typedef PAMI::GccThreadSafeQueue<PAMI::MutexedQueue<PAMI::Mutex::BGQ::L2IndirMutex> > GenericDeviceWorkQueue;
//typedef PAMI::ArrayBasedQueue<PAMI::Mutex::BGQ::L2IndirMutex> GenericDeviceWorkQueue;
