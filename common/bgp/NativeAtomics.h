...
/// #warning \todo need constant for BG/P cacheline size...
#define PAMI_BGP_NATIVE_ATOMIC_ALIGN	64
...
public:
	static const int ALIGNMENT = PAMI_BGP_NATIVE_ATOMIC_ALIGN; // for in-place decl and indirect alloc
...
private:
	volatile size_t _atom __attribute__((__aligned__(PAMI_BGP_NATIVE_ATOMIC_ALIGN)));
}; // class NativeAtomic
