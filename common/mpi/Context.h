 ...
 */
  ...
  public:
	...
	XMI::Device::MPISyncDev::Factory::init(_mpimsync, clientid, contextid, clt, ctx, _mm, _generics);
	XMI::Device::MPIBcastDev::Factory::init(_mpimcast, clientid, contextid, clt, ctx, _mm, _generics);
	return XMI_SUCCESS;
    }
